...
func builtInSkills() []SkillRecord {
	records := []SkillRecord{
		...
		},
		{
			...
			Actions: []SkillAction{
				{ID: "websearch.query", Name: "Web Search", Description: "Search the web and return structured results with snippets, providers, and source metadata.", PermissionLevel: "read", IsEnabled: true},
				{ID: "web.fetch_page", Name: "Fetch Page", Description: "Fetch and extract content, metadata, headings, and excerpts from a URL.", PermissionLevel: "read", IsEnabled: true},
				{ID: "web.research", Name: "Deep Research", Description: "Multi-source research on a topic with fetched evidence and source confidence.", PermissionLevel: "read", IsEnabled: true},
				{ID: "web.news", Name: "News", Description: "Recent news on a topic with freshness-aware structured results.", PermissionLevel: "read", IsEnabled: true},
				{ID: "web.check_url", Name: "Check URL", Description: "Verify a URL is reachable.", PermissionLevel: "read", IsEnabled: true},
				{ID: "web.multi_search", Name: "Multi Search", Description: "Run multiple searches in parallel and return grouped structured results.", PermissionLevel: "read", IsEnabled: true},
				{ID: "web.search_latest", Name: "Latest Search", Description: "Search the web for the latest information on a topic.", PermissionLevel: "read", IsEnabled: true},
				{ID: "web.search_docs", Name: "Docs Search", Description: "Search official docs and references for a topic.", PermissionLevel: "read", IsEnabled: true},
		...
		},
		{
			Manifest: SkillManifestInfo{
				...
				Description:    "Create, inspect, update, and manage Atlas team agents.",
				LifecycleState: "enabled", RiskLevel: "medium", IsUserVisible: true,
				Category: "automation", Capabilities: []string{"team_management", "agent_management"}, Tags: []string{"team", "agents", "agnts", "delegation"},
			},
			Actions: []SkillAction{
				{ID: "team.list", Name: "List Agents", Description: "List Atlas team agents and their runtime state.", PermissionLevel: "read", ApprovalPolicy: "auto_approve", IsEnabled: true},
				{ID: "team.get", Name: "Get Agent", Description: "Inspect an Atlas team agent by ID.", PermissionLevel: "read", ApprovalPolicy: "auto_approve", IsEnabled: true},
				{ID: "team.create", Name: "Create Agent", Description: "Create a new Atlas team agent.", PermissionLevel: "execute", ApprovalPolicy: "auto_approve", IsEnabled: true},
				{ID: "team.update", Name: "Update Agent", Description: "Update an Atlas team agent by ID.", PermissionLevel: "execute", ApprovalPolicy: "auto_approve", IsEnabled: true},
				{ID: "team.delete", Name: "Delete Agent", Description: "Delete an Atlas team agent by ID.", PermissionLevel: "execute", ApprovalPolicy: "auto_approve", IsEnabled: true},
				{ID: "team.enable", Name: "Enable Agent", Description: "Enable a disabled Atlas team agent.", PermissionLevel: "execute", ApprovalPolicy: "auto_approve", IsEnabled: true},
				{ID: "team.disable", Name: "Disable Agent", Description: "Disable an Atlas team agent.", PermissionLevel: "execute", ApprovalPolicy: "auto_approve", IsEnabled: true},
				...
				{ID: "team.delegate", Name: "Delegate To Agent", Description: "Delegate a focused task to an existing Atlas team agent.", PermissionLevel: "execute", ApprovalPolicy: "auto_approve", IsEnabled: true},
			},
		},
		{
			Manifest: SkillManifestInfo{
		...
		},
		{
			...
			Actions: []SkillAction{
				...
				// Extended actions
				{ID: "browser.right_click", Name: "Right Click", Description: "Right-click a page element.", PermissionLevel: "draft", IsEnabled: true},
				{ID: "browser.double_click", Name: "Double Click", Description: "Double-click a page element.", PermissionLevel: "draft", IsEnabled: true},
				{ID: "browser.key_press", Name: "Key Press", Description: "Press a keyboard key (e.g. Enter, Escape, Tab).", PermissionLevel: "execute", IsEnabled: true},
				{ID: "browser.go_back", Name: "Go Back", Description: "Navigate back in browser history.", PermissionLevel: "read", IsEnabled: true},
				{ID: "browser.go_forward", Name: "Go Forward", Description: "Navigate forward in browser history.", PermissionLevel: "read", IsEnabled: true},
				{ID: "browser.reload", Name: "Reload", Description: "Reload the current page.", PermissionLevel: "read", IsEnabled: true},
				{ID: "browser.get_html", Name: "Get HTML", Description: "Get the inner HTML of an element.", PermissionLevel: "read", IsEnabled: true},
				{ID: "browser.find_all", Name: "Find All", Description: "Find all elements matching a CSS selector.", PermissionLevel: "read", IsEnabled: true},
				{ID: "browser.get_input_value", Name: "Get Input Value", Description: "Get the current value of an input field.", PermissionLevel: "read", IsEnabled: true},
				{ID: "browser.set_viewport", Name: "Set Viewport", Description: "Resize the browser viewport.", PermissionLevel: "execute", IsEnabled: true},
				{ID: "browser.get_cookies", Name: "Get Cookies", Description: "Get all cookies for the current page.", PermissionLevel: "read", IsEnabled: true},
				{ID: "browser.set_cookie", Name: "Set Cookie", Description: "Set a cookie on the current page.", PermissionLevel: "execute", IsEnabled: true},
				{ID: "browser.delete_cookies", Name: "Delete Cookies", Description: "Delete all cookies for the current page.", PermissionLevel: "execute", IsEnabled: true},
				{ID: "browser.get_local_storage", Name: "Get Local Storage", Description: "Read a localStorage value by key.", PermissionLevel: "read", IsEnabled: true},
				{ID: "browser.set_local_storage", Name: "Set Local Storage", Description: "Write a localStorage value.", PermissionLevel: "execute", IsEnabled: true},
				{ID: "browser.save_pdf", Name: "Save PDF", Description: "Save the current page as a PDF file.", PermissionLevel: "execute", IsEnabled: true},
				{ID: "browser.accept_dialog", Name: "Accept Dialog", Description: "Accept an alert/confirm/prompt dialog.", PermissionLevel: "execute", IsEnabled: true},
				{ID: "browser.dismiss_dialog", Name: "Dismiss Dialog", Description: "Dismiss an alert/confirm/prompt dialog.", PermissionLevel: "execute", IsEnabled: true},
				{ID: "browser.check", Name: "Check/Uncheck", Description: "Check or uncheck a checkbox or radio button.", PermissionLevel: "execute", IsEnabled: true},
				{ID: "browser.drag_drop", Name: "Drag & Drop", Description: "Drag an element and drop it on another.", PermissionLevel: "execute", IsEnabled: true},
				{ID: "browser.focus", Name: "Focus", Description: "Focus a page element.", PermissionLevel: "draft", IsEnabled: true},
				{ID: "browser.extract_table", Name: "Extract Table", Description: "Extract an HTML table into a 2-D array.", PermissionLevel: "read", IsEnabled: true},
				// Emulation
				{ID: "browser.emulate_device", Name: "Emulate Device", Description: "Emulate a named device (viewport, UA, touch).", PermissionLevel: "execute", IsEnabled: true},
				{ID: "browser.set_user_agent", Name: "Set User Agent", Description: "Override the browser User-Agent string.", PermissionLevel: "execute", IsEnabled: true},
				{ID: "browser.set_geolocation", Name: "Set Geolocation", Description: "Fake the browser's GPS location.", PermissionLevel: "execute", IsEnabled: true},
				{ID: "browser.set_color_scheme", Name: "Set Color Scheme", Description: "Emulate prefers-color-scheme (dark/light).", PermissionLevel: "execute", IsEnabled: true},
				{ID: "browser.set_network_throttle", Name: "Set Network Throttle", Description: "Throttle network to simulate slow connections.", PermissionLevel: "execute", IsEnabled: true},
				{ID: "browser.clear_emulation", Name: "Clear Emulation", Description: "Reset all browser emulation overrides.", PermissionLevel: "execute", IsEnabled: true},
			},
		},
		{
			Manifest: SkillManifestInfo{
