	...
	return []SkillRecord{
		...
		},
		{
			...
			Actions: []SkillAction{
				...
				{ID: "fs.ensure_pdf_engine", Name: "Install PDF Engine", Description: "Install pandoc+typst via Homebrew for rich PDF output.", PermissionLevel: "execute", IsEnabled: true},
