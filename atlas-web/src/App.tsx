...
export function App() {
  ...
  const setUIRadius = (uiRadius: UIRadius) =>
    setThemeConfig(prev => ({ ...prev, uiRadius }))

  const setUIBlur = (uiBlur: UIBlur) =>
    setThemeConfig(prev => ({ ...prev, uiBlur }))

  const setUIFont = (uiFont: UIFont) =>
